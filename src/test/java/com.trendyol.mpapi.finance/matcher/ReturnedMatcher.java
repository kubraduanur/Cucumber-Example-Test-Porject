...
public class ReturnedMatcher {
    public static boolean isTrueSettlementReturned(OrderSummary orderSummary) {
        ...
        for (LineItemInfo lineItemInfo : orderSummary.getOrderLineItems()) {
            if (lineItemInfo.getPrice()<=13000) {
                isAllItemTrue = isAllItemTrue &&
                        Objects.equals("Returned", orderSummary.getOmsOrderStatus()) &&
                        ...
                        Objects.equals("Returned", lineItemInfo.getStatus())&&
